...
<ResponseField name="records" type="object[]">
  A slice of row hook record objects. The maximum number of records is controlled by [`batchRowHookBatchSize`](/reference/settings/settings#param-batch-row-hook-batch-size), which defaults to `2000`.
</ResponseField>
