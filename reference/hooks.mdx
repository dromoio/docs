...
For more information on invalidDataBehavior, see the [Settings](/reference/settings/settings#invaliddatabehavior) documentation.

For more information on the instance.addField method, see the [Instance Methods](/reference/hooks#instanceaddfield) documentation.
