...
For more information on the Get Upload Data API, see the [API Reference](/api-reference/uploads/get-upload-metadata).

For more information on the Retrieve Headless Import API, see the [API Reference](/api-reference/headless/retrieve-headless-import).

For more information on webhookUrl, see the [Settings](/reference/settings/settings#webhookurl) documentation.
