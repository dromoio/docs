---
title: "Import Results Callbacks and Metadata"
description: "Reference for Dromo's onResults and beforeFinish callbacks, returned row data, import metadata, and completion control."
---
