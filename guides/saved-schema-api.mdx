...
<AccordionGroup>
  <Accordion title="Row hook example">
    Define your row hook as a JavaScript function:
    ...
    <Note>
      When passing to the API, the function must be stringified on a single line as shown in the API Payload tab.
    </Note>
  </Accordion>

  <Accordion title="Step hook example">
    Define your step hook as a JavaScript function:
