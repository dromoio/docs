...
For more information on configuring your schema, see the [Settings](/reference/settings/settings) documentation.

For more information on hooks, see the [Hooks](/reference/hooks) documentation.

For more information on row hooks, see the [Standard Row Hooks](/reference/hooks#standard-row-hooks) documentation.

For more information on bulk row hooks, see the [Bulk Row Hooks](/reference/hooks#bulk-row-hooks) documentation.

For more information on row delete hooks, see the [Row Delete Hooks](/reference/hooks#row-delete-hooks) documentation.
