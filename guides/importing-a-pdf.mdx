...
In this guide, we’ll build a [custom file parser](/custom-file-parsers) to support PDF uploads using the PDFTables API to extract tables from PDFs.

## Getting Started

For our example we're importing users from a table in a PDF document.

![PDF Contents](/images/guides/assets/images/customParserPDF.png)
...
![extensions include pdf image](/images/guides/assets/images/extensions_include_pdf.png)

Drag and drop your PDF test file. Your data should be properly parsed and loaded.

![parsed pdf data](/images/guides/assets/images/parsed_pdf_data.png)
