...
description: "Save an in-progress Dromo import, restore it later across devices, and securely manage session and hydration tokens."
---
...
|---|---|---|
| `POST` | `/api/widget/session/v2/auth/` | Create a new session. Returns `sessionId`, `hydrationId`, and `expiresAt`. |
