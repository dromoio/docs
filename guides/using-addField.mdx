---
title: "Concatenating and Splitting Fields via addField"
description: "Create computed or dynamic fields during the review stage with step hooks and populate them with a correctly shaped row-hook output."
---
...
dromo.registerRowHook(function (data, mode) {
  let out: IRowHookOutput = { row: { ...data.row } };
