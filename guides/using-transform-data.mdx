...
description: "Dromo's Transform Data feature allows your users to create bulk transformations from natural language and execute them on the dataset. The feature is available on the ."
---
...
#### Include context about inputs[​](#include-context-about-inputs "Direct link to Include context about inputs")
...
#### Only apply transformations to one row at a time[​](#only-apply-transformations-to-one-row-at-a-time "Direct link to Only apply transformations to one row at a time")
...
#### Keep Expectations Realistic[​](#keep-expectations-realistic "Direct link to Keep Expectations Realistic")
