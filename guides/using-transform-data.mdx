...
![Transform data button](/images/guides/assets/images/review_screen_button.png)

Click this button to open the Transform Data modal. You will be prompted for what you would like to do to your data.

![Transform data prompt](/images/guides/assets/images/empty_prompt.png)
...
![Data Change Preview](/images/guides/assets/images/last-comma-first.png)

The feature can edit values and remove rows. It cannot add rows.

![Remove low value rows](/images/guides/assets/images/remove-cheap-rows.png)
...
![date-example](/images/guides/assets/images/date-format.png)
...
![failed prompt](/images/guides/assets/images/failed-prompt.png)
