...
description: "Create, configure, test, and manage Dromo import schemas visually with Schema Studio in the Dromo dashboard."
---
...
<Steps>
  ...
  <Step title="Add fields to your schema">
    ...
    * Type: The [type](/reference/fields/field-types) of data your user should input (e.g., email, date, text, etc.).
    ...
    Additionally, you can use [**validators**](/reference/fields/field-validators) to enforce rules for the data a user is allowed to import. You can choose to make a field required, unique, follow a particular [Regex](https://en.wikipedia.org/wiki/Regular_expression) pattern, or any combination of the above:
