...
![Navigate to Schema Studio](/images/guides/assets/images/highlight_dashboard_schemaBuilder.png)

<Steps>
  <Step title="Add a Name">
    ![Adding a schema name](/images/guides/assets/images/add_schema_name.png)
  </Step>

  <Step title="Customize your importer">
    Next, you can customize the importer your end-user interacts with:

    ![Customizing the general settings of your Dromo importer](/images/guides/assets/images/schemaBuilder_general_settings.png)
    ...
    * private mode settings
    ...
    ![Use the Test Now button to see your importer](/images/guides/assets/images/test_now.png)
  </Step>
  ...
  <Step title="Add fields to your schema">
    ...
    ![Use an existing file or manually add fields](/images/guides/assets/images/add_fields.png)
    ...
    * Type: The [type](/fields/field-types) of data your user should input (e.g., email, date, text, etc.).
    ...
    ![The options to customize a field](/images/guides/assets/images/customize_field1.png)
    ...
    ![The validators you can add to a field](/images/guides/assets/images/customize_field2.png)

    You can try out your importer settings and fields in real-time using the **Test now** button on the footer on the screen:

    ![Click test now to try our your schema](/images/guides/assets/images/test_now_focus.png)
    ...
    ![New schema added to total list](/images/guides/assets/images/new_schema_added.png)
  </Step>
</Steps>
...
![Schema icons](/images/guides/assets/images/angled_brackets_focus.png)
...
![No set user for an Import](/images/guides/assets/images/no_set_user_in_imports.png)
...
![Development Mode](/images/guides/assets/images/development_mode_banner.png)
