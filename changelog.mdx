...
<<<<<<< Updated upstream
=======
<Update label="May 2026" description="v3.12.0" tags={["Review Step", "Validation", "Analytics", "Observability"]}>
...
See [`reviewStep.enableNavigatingErrors`](/reference/settings/settings#enablenavigatingerrors) in the Settings reference for full details.
