...
<Update label="March 2026" description="v3.9.0" tags={["Customization", "Styling"]}>

## Button Style Overrides

New styling properties for `primaryButton`, `secondaryButton`, and `tertiaryButton` in `styleOverrides`.
...
These properties are available on all three button types and can be configured via the `styleOverrides` object passed during Dromo initialization.
